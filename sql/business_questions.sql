...
-- Supplementary: Furniture Discount Bracket Analysis
-- Purpose: Quantify the impact of discount levels on Furniture profitability
-- to support Recommendation #2 (discount cap at 10%)
SELECT 
    CASE 
...
-- Finding: Furniture profitability collapses sharply beyond 10% discount.
-- No Discount: 22.71% margin (836 orders)
-- 1-10% discount: 15.25% margin (76 orders)
-- 11-20% discount: 3.15% margin (667 orders) — margin nearly wiped out
-- 21-30% discount: -10.75% margin (222 orders) — loss-making
-- Above 30% discount: -45.76% margin (320 orders) — catastrophic losses
-- Conclusion: The 10% discount cap recommendation is directly supported by this data.
-- Orders above 10% discount represent 1,209 orders generating -$46,792.82 in combined losses.